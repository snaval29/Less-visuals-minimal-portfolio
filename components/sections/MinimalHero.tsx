...
export const MinimalHero = () => {
  return (
    <section className="relative w-full flex flex-col justify-start bg-white text-neutral-900 pt-20 pb-0 md:pt-32 md:pb-20 font-sans overflow-hidden">
      
      {/* --- ASSET LAYER --- */}
      <div className="absolute inset-0 pointer-events-none z-0">
        
        {/* 1. Headphones: Pushed higher (top-[12%]) and further left (left-[2%]) to clear the badge */}
        <div
          className="absolute 
          top-[12%] left-[2%] w-16 h-16
          sm:top-[12%] sm:left-[10%] sm:w-20 sm:h-20
          md:top-[19%] md:left-[25%] md:w-28 md:h-28
          lg:top-[18%] lg:left-[25%] lg:w-40 lg:h-40
          mix-blend-multiply opacity-90 transition-all duration-500"
        >
          <Image
        ...
        {/* 2. Bulb-Pencil: Increased size on mobile (w-14 h-14) and lowered to top-[16%] */}
        <div
          className="absolute 
          top-[16%] right-[6%] w-14 h-14
        ...
        {/* 3. Microphone: Anchored near the CTA for balance */}
        <div
          className="absolute 
          bottom-[10%] right-[10%] w-18 h-18
          sm:bottom-[5%] sm:left-[15%] sm:w-24 sm:h-24
          md:bottom-[8%] md:left-[40%] md:w-24 md:h-24
          lg:bottom-[6%] lg:left-[32%] lg:w-38 lg:h-38
          -rotate-[15deg] mix-blend-multiply opacity-80 transition-all duration-500"
        >
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 w-full relative z-20">
        ...
        >
          {/* Status Badge - Increased z-index to stay above background elements if they touch */}
          ...
          <p className="max-w-[85%] md:max-w-lg text-lg md:text-2xl text-neutral-500 font-medium leading-relaxed mb-10 tracking-tight">
          ...
          <div className="flex items-center gap-6 mb-16 md:mb-0">
            <a 
                href="/resume.pdf" 
                className="group relative inline-flex items-center gap-3 px-8 py-4 bg-neutral-900 text-white rounded-2xl shadow-xl active:scale-95 transition-transform"
            >
